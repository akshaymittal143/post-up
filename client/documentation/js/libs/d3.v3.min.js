...
!(function() {
        ...
        if (((u = e - l), h || !(u < 0))) {
          ...
          if (((u = t - c), p || !(u > 0))) {
            ...
            if (((u = r - c), p || !(u < 0))) {
              ...
              return (
                f > 0 && (i.a = { x: l + f * h, y: c + f * p }), s < 1 && (i.b = { x: l + s * h, y: c + s * p }), i
              );
            }
          }
        }
  ...
  function He(n) {
    ...
    if ((Ja.insert(t, l), t || e)) {
      if (t === e)
        return Be(t), (e = je(t.site)), Ja.insert(l, e), (l.edge = e.edge = Ke(t.site, l.site)), $e(t), void $e(e);
      if (e) {
        Be(t), Be(e);
        var c = t.site,
          f = c.x,
  ...
  function Ze(n) {
    for (
      var t, e, r, i, u, o, a, l, c, f, s = n[0][0], h = n[1][0], p = n[0][1], g = n[1][1], d = Wa, v = d.length;
      v--;
    ...
    return (
      (function n(c, f, s, h, p) {
        if (!(f > u || s > o || h < r || p < i)) {
          ...
          for (
            var x = c.nodes, M = 0.5 * (f + h), _ = 0.5 * (s + p), b = ((e >= _) << 1) | (t >= M), w = b + 4;
            b < w;
            ++b
          )
            if ((c = x[3 & b]))
  ...
  function tu(n, t) {
    ...
    return (
      ...
      (o.invertExtent = function(e) {
        return (
          (e = t.indexOf(e)), e < 0 ? [NaN, NaN] : [e > 0 ? a[e - 1] : n[0], e < a.length ? a[e] : n[n.length - 1]]
        );
      }),
      (o.copy = function() {
        return tu(n, t);
      ...
      function e(n, e) {
        ...
        if (t) {
          var v,
            ...
            m = new Array(o);
          for (r = -1; ++r < o; )
            (i = n[r]) && (y.has((v = t.call(i, i.__data__, r))) ? (d[r] = i) : y.set(v, i), (m[r] = v));
          for (r = -1; ++r < s; )
  ...
  (to.selection.enter = Z),
    ...
    (to.select = function(t) {
      var e;
      return (
        'string' == typeof t ? ((e = [mo(t, io)]).parentNode = io.documentElement) : ((e = [t]).parentNode = n(t)),
        E([e])
      );
    }),
    (to.selectAll = function(n) {
      var t;
      return (
        'string' == typeof n ? ((t = ro(xo(n, io))).parentNode = io.documentElement) : ((t = ro(n)).parentNode = null),
        E([t])
      );
    }),
  ...
  (to.geo.bounds = (function() {
    ...
    (to.geo.centroid = function(n) {
      ...
      var t = ka,
        ...
        i = t * t + e * e + r * r;
      return i < zo &&
        ((t = ba), (e = wa), (r = Sa), ma < Co && ((t = xa), (e = Ma), (r = _a)), (i = t * t + e * e + r * r) < zo)
        ? [NaN, NaN]
        ...
        if (
          ...
          if (n && n.C) n.C = !1;
            ...
            do {
              ...
              if (n === i.L) {
                if (
                  ((t = i.R).C && ((t.C = !1), (i.C = !0), ir(this, i), (t = i.R)), (t.L && t.L.C) || (t.R && t.R.C))
                ) {
  ...
  (to.layout.histogram = function() {
    function n(n, u) {
      ...
      if (p > 0)
        for (u = -1; ++u < h; )
          (a = c[u]) >= f[0] && a <= f[1] && (((o = l[to.bisect(s, a, 1, p) - 1]).y += g), o.push(n[u]));
      return l;
    }
    var t = !0,
      e = Number,
    ...
    (to.layout.treemap = function() {
      ...
      return (
        ...
        (u.padding = function(n) {
          ...
          return (
            (s =
              null == (f = n) ? Di : 'function' == (r = typeof n) ? t : 'number' === r ? ((n = [n, n, n, n]), e) : e),
            u
          );
        }),
        (u.round = function(n) {
    ...
    function u() {
      ...
      function y(n, t, e) {
        ...
        if (
          ...
          C
            ? (i = (r += f) + v)
            : (x && (f = Math.max(l, Math.min(c, 2 * x[e] - r))), f < r ? ((i = r), (r = f)) : (i = f)),
          d[0] != r || d[1] != i)
        )
