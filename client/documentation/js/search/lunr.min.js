!(function() {
  var t,
    ...
    z = function(e) {
      var t = new z.Builder();
      return (
        t.pipeline.add(z.trimmer, z.stopWordFilter, z.stemmer), t.searchPipeline.add(z.stemmer), e.call(t, t), t.build()
      );
    };
  (z.version = '2.3.2'),
    (z.utils = {}),
    ...
    (z.FieldRef.prototype.toString = function() {
      return (
        null == this._stringValue && (this._stringValue = this.fieldName + z.FieldRef.joiner + this.docRef),
        this._stringValue
      );
    }),
    (z.Set = function(e) {
    ...
    (i = function(e) {
      ...
      (n = T).test(e) &&
        ((t = (u = n.exec(e))[1]), (s = f), (o = I), ((n = d).test(t) || (s.test(t) && !o.test(t))) && (e = t));
      return (
        (s = d),
      ...
      for (var r = new z.TokenSet(), i = [{ node: r, editsRemaining: t, str: e }]; i.length; ) {
        ...
        if (0 < a.str.length)
          (s = a.str.charAt(0)) in a.node.edges
            ...
            1 == a.str.length
              ? (n.final = !0)
              : i.push({ node: n, editsRemaining: a.editsRemaining, str: a.str.slice(1) });
        if (0 < a.editsRemaining && 1 < a.str.length)
          (s = a.str.charAt(1)) in a.node.edges
            ...
            a.str.length <= 2
              ? (o.final = !0)
              : i.push({ node: o, editsRemaining: a.editsRemaining - 1, str: a.str.slice(2) });
        if (
          (0 < a.editsRemaining && 1 == a.str.length && (a.node.final = !0), 0 < a.editsRemaining && 1 <= a.str.length)
        ) {
          ...
          1 == a.str.length
            ? (u.final = !0)
            : i.push({ node: u, editsRemaining: a.editsRemaining - 1, str: a.str.slice(1) });
        }
        ...
        if (0 < a.editsRemaining && 1 < a.str.length) {
          ...
          d in a.node.edges ? (c = a.node.edges[d]) : ((c = new z.TokenSet()), (a.node.edges[d] = c)),
            1 == a.str.length
              ? (c.final = !0)
              : i.push({ node: c, editsRemaining: a.editsRemaining - 1, str: h + a.str.slice(2) });
        }
      }
      return r;
    }),
    ...
    (z.TokenSet.prototype.intersect = function(e) {
      for (var t = new z.TokenSet(), r = void 0, i = [{ qNode: e, output: t, node: this }]; i.length; ) {
        r = i.pop();
        for (
          var n = Object.keys(r.qNode.edges), s = n.length, o = Object.keys(r.node.edges), a = o.length, u = 0;
          u < s;
          u++
        )
            ...
            for (y = 0; y < u.fields.length; y++) {
              ...
              if (
                (u.presence == z.Query.presence.REQUIRED &&
                  ((c = c.union(S)), void 0 === s[R] && (s[R] = z.Set.complete)),
    ...
    (z.Builder.prototype.createFieldVectors = function() {
      for (
        var e = {}, t = Object.keys(this.fieldTermFrequencies), r = t.length, i = Object.create(null), n = 0;
        n < r;
        n++
      ) {
        for (
          ...
          void 0 === i[x] ? ((y = z.idf(this.invertedIndex[x], this.documentCount)), (i[x] = y)) : (y = i[x]),
            (m =
              (y * ((this._k1 + 1) * v)) / (this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[o])) + v)),
            (m *= d),
            (m *= f),
